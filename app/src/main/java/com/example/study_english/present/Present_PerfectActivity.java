...
public class Present_PerfectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_present__perfect);
        flipper = findViewById(R.id.viewflipper);
        Button button_back1 = findViewById(R.id.button_back1);
        button_back1.setOnClickListener(v -> onBackPressed());
    }
